...
namespace bird {
    ...
    void Application::initWindow() {
        ...
        m_pWindow = glfwCreateWindow(1280, 720, "Vulkan Tutorial", nullptr, nullptr);
        glfwSetWindowUserPointer(m_pWindow, this);
        glfwSetWindowSizeCallback(m_pWindow, resizeWindowGlfwCallback);
    ...
    void Application::createInstance() {
        ...
        appInfo.pEngineName = "Bird Engine";
    ...
    void Application::createTextureImage() {
        ...
        if(!pixels) {
            throw std::runtime_error("Failed to load textured image!");
        }
    ...
    void Application::createImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkSampleCountFlagBits samples, VkFormat format, VkImageTiling tiling,
    ...
    void Application::generateMipmaps(VkImage image, VkFormat format, int32_t texWidth, int32_t texHeight,
                                      uint32_t mipLevels) {
    ...
    void Application::createGraphicsPipeline() {
        auto vertFile = readFile("shaders/vertex.vert.spv");
        auto fragFile = readFile("shaders/fragment.frag.spv");
    ...
    void Application::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
        ...
        renderPassInfo.framebuffer = m_swapChainFramebuffers[imageIndex]; // FAILURE
    ...
    void Application::resizeWindowGlfwCallback(GLFWwindow *window, int width, int height) {
