...
namespace bird::vk {
    ...
    VKRenderPass::VKRenderPass(const VKPhysicalDevice* pPhysicalDevice, const VKLogicalDevice* pDevice, const VKSwapChain* pSwapChain) : m_pPhysicalDevice(pPhysicalDevice), m_pDevice(pDevice), m_pSwapChain(pSwapChain) {
        createRenderPass();
    }
    ...
    VkFormat VKRenderPass::findSupportedFormat(const std::vector<VkFormat> &candidates, VkImageTiling tiling,
