...
namespace bird {
    ...
    template <typename T, uint8_t t_attributeSize = 3> class Buffer {
    public:
    ...
    template <typename T, uint8_t t_attributeSize> const BufferMode& Buffer<T, t_attributeSize>::getBufferMode() const {
        return m_bufferMode;
    }
